		...
		<c:choose>
			<c:when test="${not empty listWeu }">
				<c:forEach var="weu" items="${listWeu }">
					<div class="move" href='${weu.p_num }'>
						<div class="pakageList">
							<div>
								<img alt="이미지" src="/resources/images/${weu.p_mainimg }"
									width="250px" height="180px">
							</div>
							<div>
								<c:out value="${weu.p_region2}"></c:out>
								<br>
								<c:out value="${weu.p_name}"></c:out>
								<br>
								<c:out value="${weu.p_period}"></c:out>
								<br>
								<c:choose>
								...
								<br>
								<fmt:formatNumber value="${weu.p_fee }" pattern="#,###" />
								원 /1인
							</div>
						</div>
					</div>
		...
		<c:choose>
			<c:when test="${not empty listSai }">
				<c:forEach var="sai" items="${listSai }">
					<div class="move" href='${sai.p_num }'>
						<div class="pakageList">
							<div>
								<img alt="이미지" src="/resources/images/${sai.p_mainimg }"
									width="250px" height="180px">
							</div>
							<div>
								<c:out value="${sai.p_region2}"></c:out>
								<br>
								<c:out value="${sai.p_name}"></c:out>
								<br>
								<c:out value="${sai.p_period}"></c:out>
								<br>
								<c:choose>
								...
								<br>
								<fmt:formatNumber value="${sai.p_fee }" pattern="#,###" />
								원 /1인
							</div>
						</div>
					</div>
			...
			<c:when test="${not empty listkos }">
				<c:forEach var="kos" items="${listkos }">
					<a class="move" href='${kos.p_num }'>
						<div class="pakageList">
							<div>
								<img alt="이미지" src="/resources/images/${kos.p_mainimg }"
									width="250px" height="180px">
							</div>
							<div>
								<c:out value="${kos.p_region2}"></c:out>
								<br>
								<c:out value="${kos.p_name}"></c:out>
								<br>
								<c:out value="${kos.p_period}"></c:out>
								<br>
								<c:choose>
								...
								<br>
								<fmt:formatNumber value="${kos.p_fee }" pattern="#,###" />
								원 /1인
							</div>
						</div>
					</a>
