		...
		<div class="contents" style="display: flex; justify-content: center;">
			...
			<!-- enctype 멀티 어쩌고 삭제하니까 400 에러 사라짐 -->
				<table class="boardTbl" style="border: 1px solid pink; max-width: 800px">
					<thead>
						<tr>
							<td colspan="2">!! 자주찾는질문 등록하기 !!</td>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td>제목</td>
							<td><input type="text" name="fq_title" style="float: left;"></td>
						</tr>
						<tr>
							<td>카테고리</td>
							<td>
						...
						<tr>
							<td>내용</td>
							<td><textarea rows="10" cols="80" name="fq_content" ></textarea></td>
						</tr>
						<tr >
							<td>파일</td>
							<td class="uploadDiv">
					...
					<tfoot>
						<tr>
							<td colspan="2">
								...
								<button data-oper="list" onclick="location.href='/freq/list'" type="button">목록.!!!</button>
