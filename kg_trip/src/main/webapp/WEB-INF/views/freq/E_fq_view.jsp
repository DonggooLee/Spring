			...
			<table class="boardTbl" style="border: 1px solid pink; max-width: 800px">
				<tbody>
					...
					<tr>
						...
						<td><c:out value="${freq.m_idx }" /></td>
					</tr>
					<tr>
						<td>제목</td>
						<td><c:out value="${freq.fq_title }" /></td>
					</tr>
					<tr>
						<td>내용</td>
						<td>${freq.fq_content }</td>
					</tr>
					<tr>
						<td>파일</td>
						<td>
							<img src="/img/${freq.fq_file }" style="max-width: 800px">
						</td>
					</tr>
					<tr>
						<td>등록일</td>
						<td><fmt:formatDate value="${freq.fq_regDate}"
