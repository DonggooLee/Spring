...
<section class="cont">
	...
	<form action="/KingTrip/join/joinFormP" method="post" role="form">
...
<script>
	...
	$("#m_id").blur(function() {
		...
		$.ajax({
			url : '${pageContext.request.contextPath}/KingTrip/public/idCheckP?m_id='+ m_id,
			type : 'get',
		...
		$("#m_email").blur(function() {
			...
			$.ajax({
				url : '${pageContext.request.contextPath}/KingTrip/public/emailCheckP?m_email='+ m_email,
				type : 'get',
				success : function(data) {
					console.log("1 = 중복o / 0 = 중복x : "+ data);							
			...
			$("#m_phone").blur(function() {
				...
				$.ajax({
					url : '${pageContext.request.contextPath}/KingTrip/public/phoneCheckP?m_phone='+ m_phone,
					type : 'get',
					success : function(data) {
						console.log("1 = 중복o / 0 = 중복x : "+ data);							
