...
public class k_KakaopayPay {
	...
	public KakaoPayApprovalVO kakaoPayInfo(KakaoPayDTO dto) {
        ...
        try {
            ...
            kakaoPayApprovalVO.setReservation_idx(dto.getReservation_idx());
	...
	public KakaoPayCancelVO kakaoPayCancel(K_bookInfo bookInfo) {
        ...
        params.add("cancel_amount", Integer.toString(bookInfo.getTicket_price()));
