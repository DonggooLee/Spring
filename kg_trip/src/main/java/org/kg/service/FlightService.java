...
public interface FlightService {
	...
	// 좌석 조회 : 조건 => 일정번호, 항공편명
	public List<K_choiceSeatVO> choiceSeat_(@Param("date_idx") int date_idx, @Param("flight_name") String flight_name);
	
	// 좌석 조회 : 조건 => 좌석번호
	public K_seatVO getSeat_(@Param("seat_idx") int seat_idx);
