...
public class K_FlightController {
	...
	public String choiceSeat(@RequestParam("date_idx") int date_idx, @RequestParam("seat_grade") String seat_grade, @RequestParam("flight_name") String flight_name, Model model) {
